export const zh = {
  ...
  "provider.type.openai-compat": "兼容 OpenAI 的第三方服务",
  "provider.intro": "API 密钥以加密形式存储在本机。",
  "provider.active": "当前使用",
  "provider.noKey": "未设置密钥",
  ...
  "provider.rejected": "{provider} 拒绝了该密钥——请检查后重试。",
  "provider.busy": "请先结束当前回合。",
  "provider.unverified": "已保存，但无法连接验证——若黑塔没有回应，请检查网络。",
  "provider.unencrypted": "已明文存储——此设备没有可用的安全密钥链。",
  "provider.thinking.low": "低",
  "provider.thinking.medium": "中",
  "provider.thinking.high": "高",
  "provider.thinking.xhigh": "极高",
  "provider.thinking.max": "最高",
  "provider.thinking.off": "关闭",
  "provider.thinking.none": "无",
  "provider.thinking.minimal": "极小",
  "nav.language": "语言",
  "nav.window": "窗口",
  "nav.update": "更新",
  "update.intro":
  ...
  "composer.context.recap": "已压缩摘要 {chars} 字符",
  "composer.context.compress": "压缩",
  ...
  "mcp.loading": "正在载入 MCP 配置…",
  "mcp.empty": "尚未配置 MCP 服务。添加一个服务即可让新会话使用它的工具。",
  "mcp.server": "服务 {n}",
  "mcp.remove": "删除",
  "mcp.removeAria": "删除 MCP 服务 {name}",
  "mcp.name": "服务名称",
  "mcp.namePlaceholder": "例如 filesystem",
  "mcp.transport": "传输方式",
  "mcp.transport.stdio": "本地 stdio",
  "mcp.transport.http": "远程 Streamable HTTP",
  "mcp.transport.sse": "远程 SSE（旧版）",
  "mcp.command": "启动命令",
  "mcp.commandPlaceholder": "例如 npx",
  "mcp.args": "命令参数",
  "mcp.argsDesc": "每行一个参数，按顺序传给本地服务进程。",
  "mcp.argsPlaceholder":
    "-y\n@modelcontextprotocol/server-filesystem\n/你的目录",
  "mcp.env": "环境变量",
  "mcp.envDesc": "每行一个 KEY=VALUE；敏感值会保存在工作区配置文件中。",
  "mcp.envPlaceholder": "API_KEY=你的密钥",
  "mcp.url": "服务器地址",
  "mcp.urlPlaceholder": "https://example.com/mcp",
  "mcp.headers": "请求头",
  "mcp.headersDesc": "每行一个 KEY=VALUE，例如 Authorization=Bearer token。",
