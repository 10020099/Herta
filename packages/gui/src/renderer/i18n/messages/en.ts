...
export const en = {
  ...
  "provider.baseUrl": "API Base URL (optional)",
  ...
  "provider.type.openai-compat": "OpenAI-compatible Third-party",
  "provider.intro": "API keys are stored encrypted on this machine.",
  "provider.active": "Active",
  "provider.noKey": "No key set",
  ...
  "provider.thinking.xhigh": "XHigh",
  "provider.thinking.max": "Max",
  "provider.thinking.off": "Off",
  "provider.thinking.none": "None",
  ...
  "composer.context.recap": "Compressed recap: {chars} characters",
  "composer.context.compress": "Compress",
  "composer.context.pending": "Will compact before your next message",
